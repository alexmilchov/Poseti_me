...
?>
            ...
            interval_id = setInterval(function(){
                if(i >= json.length){
					...
					if(current_sight['wikipedia_link'] != ''){
						html += '<a target="_blank" href="'+current_sight['wikipedia_link']+'">Източник</a>';
					}
					html += "</div>";
    ...
    <center><h1>Посетени от мен</h1></center>
    <?php if(empty($visited)): ?>
        <center><p>Нямате посетени забележителности.</p></center>
    <?php else: ?>
